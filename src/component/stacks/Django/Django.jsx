...
const Django = () => {
  return (
    <section>
      <p className="font-bold text-xl text-center">Over View Of Django</p>
      <div className="sidebar-sec">
        <aside class="flex flex-col w-64 h-screen px-4 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
          ...
          <div class="flex flex-col justify-between flex-1 mt-6">
            <nav>
              <details>
                <summary>Module 1: introduction to Django</summary>
              ...
              <details>
                <summary>Module 2: Django implementation</summary>
                <ul className="lession-items">
                  <li>
                    <a href="#">Day-1: Lesson 1</a>
                  </li>
              ...
              <details>
                <summary>Module 3: Django</summary>
                <ul className="lession-items">
                  <li>
                    <a href="#">Day-1: Lesson 1</a>
                  </li>
        ...
        <div className="side-description pt-10 pr-8">
          ...
          <p className="text-left ml-2 text-lg mb-10">
              Django is an open-source JavaScript frontend library for creating
